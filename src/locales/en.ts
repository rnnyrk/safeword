export const en = {
  ...
  settings_group_extra: {
    change_group_language_title: 'Change group language',
    change_group_language_description:
      'Are you sure you want to change the language of your group? SafeWords will be in English.',
  ...
  settings_language: {
    ...
    change_language_success: 'Group language changed successfully',
